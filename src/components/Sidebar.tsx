        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 z-55 h-full w-56 bg-gray-900 text-yellow-400 shadow-lg p-4 flex flex-col"
            >

             <button
            onClick={() => setOpen(false)}
            className="self-end w-10 h-10 flex items-center justify-center bg-yellow-400 text-gray-900 rounded-full hover:bg-yellow-500 transition shadow-lg"
            aria-label="Close"
          >
            <X className="w-5 h-5" />
          </button>
